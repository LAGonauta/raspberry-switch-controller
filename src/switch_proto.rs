...
const RUMBLE_AMPLITUDES: &[(u8, u16, u16)] = &[
    (0x00, 0x0040, 0), (0x02, 0x8040, 10), (0x04, 0x0041, 12), (0x06, 0x8041, 14),
    (0x08, 0x0042, 17), (0x0a, 0x8042, 20), (0x0c, 0x0043, 24), (0x0e, 0x8043, 28),
    (0x10, 0x0044, 33), (0x12, 0x8044, 40), (0x14, 0x0045, 47), (0x16, 0x8045, 56),
    (0x18, 0x0046, 67), (0x1a, 0x8046, 80), (0x1c, 0x0047, 95), (0x1e, 0x8047, 112),
    (0x20, 0x0048, 117), (0x22, 0x8048, 123), (0x24, 0x0049, 128), (0x26, 0x8049, 134),
    (0x28, 0x004a, 140), (0x2a, 0x804a, 146), (0x2c, 0x004b, 152), (0x2e, 0x804b, 159),
    (0x30, 0x004c, 166), (0x32, 0x804c, 173), (0x34, 0x004d, 181), (0x36, 0x804d, 189),
    (0x38, 0x004e, 198), (0x3a, 0x804e, 206), (0x3c, 0x004f, 215), (0x3e, 0x804f, 225),
    (0x40, 0x0050, 230), (0x42, 0x8050, 235), (0x44, 0x0051, 240), (0x46, 0x8051, 245),
    (0x48, 0x0052, 251), (0x4a, 0x8052, 256), (0x4c, 0x0053, 262), (0x4e, 0x8053, 268),
    (0x50, 0x0054, 273), (0x52, 0x8054, 279), (0x54, 0x0055, 286), (0x56, 0x8055, 292),
    (0x58, 0x0056, 298), (0x5a, 0x8056, 305), (0x5c, 0x0057, 311), (0x5e, 0x8057, 318),
    (0x60, 0x0058, 325), (0x62, 0x8058, 332), (0x64, 0x0059, 340), (0x66, 0x8059, 347),
    (0x68, 0x005a, 355), (0x6a, 0x805a, 362), (0x6c, 0x005b, 370), (0x6e, 0x805b, 378),
    (0x70, 0x005c, 387), (0x72, 0x805c, 395), (0x74, 0x005d, 404), (0x76, 0x805d, 413),
    (0x78, 0x005e, 422), (0x7a, 0x805e, 431), (0x7c, 0x005f, 440), (0x7e, 0x805f, 450),
    (0x80, 0x0060, 460), (0x82, 0x8060, 470), (0x84, 0x0061, 480), (0x86, 0x8061, 491),
    (0x88, 0x0062, 501), (0x8a, 0x8062, 512), (0x8c, 0x0063, 524), (0x8e, 0x8063, 535),
    (0x90, 0x0064, 547), (0x92, 0x8064, 559), (0x94, 0x0065, 571), (0x96, 0x8065, 584),
    (0x98, 0x0066, 596), (0x9a, 0x8066, 609), (0x9c, 0x0067, 623), (0x9e, 0x8067, 636),
    (0xa0, 0x0068, 650), (0xa2, 0x8068, 665), (0xa4, 0x0069, 679), (0xa6, 0x8069, 694),
    (0xa8, 0x006a, 709), (0xaa, 0x806a, 725), (0xac, 0x006b, 741), (0xae, 0x806b, 757),
    (0xb0, 0x006c, 773), (0xb2, 0x806c, 790), (0xb4, 0x006d, 808), (0xb6, 0x806d, 825),
    (0xb8, 0x006e, 843), (0xba, 0x806e, 862), (0xbc, 0x006f, 881), (0xbe, 0x806f, 900),
    (0xc0, 0x0070, 920), (0xc2, 0x8070, 940), (0xc4, 0x0071, 960), (0xc6, 0x8071, 981),
    (0xc8, 0x0072, 1003),
];
...
pub fn set_report_mode_response(count: u8, input: &SwitchInput, sub_cmd: u8) -> Vec<u8> {
    subcommand_response(count, input, true, sub_cmd, &[0x01, 0x00, 0xff, 0x00, 0x03, 0x00, 0x05, 0x01])
}
